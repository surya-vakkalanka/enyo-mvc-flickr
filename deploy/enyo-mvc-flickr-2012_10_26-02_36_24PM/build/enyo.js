...
(function() {
enyo.global = this, enyo._getPath = function() {
var e, t, n, r = 0, i, s;
if (arguments.length === 0) return undefined;
if (!enyo.isString(arguments[0])) return undefined;
e = arguments, n = e[0], t = this === enyo && e[1] !== !0 ? window : this;
while (n[r] === ".") ++r;
r > 0 && (n = n.slice(r)), r = n.indexOf(".");
if (r === -1) i = t[n]; else {
s = n.substring(0, r), n = n.slice(r);
if (typeof t[s] != "object") return undefined;
i = enyo._getPath.call(t[s], n, !0);
}
return enyo.isFunction(i) && i.isProperty === !0 && !e[1] ? i.call(this) : i;
}, enyo._setPath = function() {
var e, t, n, r, i = 0, s, o, u;
if (arguments.length < 2) return this;
e = arguments, r = e[0], n = e[1], t = this;
while (r[i] === ".") ++i;
i > 0 && (r = r.slice(i)), i = r.indexOf(".");
if (i === -1) this[r] && enyo.isFunction(this[r]) && this[r].isProperty ? (u = this[r].call(this), this[r].call(this, n)) : (u = this[r], this[r] = n); else {
s = r.split(".");
while (s.length > 0) o = s.shift(), s.length === 0 ? t[o] && enyo.isFunction(t[o]) && t[o].isProperty ? (u = t[o].call(this), t[o].call(this, n)) : (u = t[o], t[o] = n) : (t[o] || (t[o] = {}), t = t[o]);
}
return this.notifyObservers && u !== n && this.notifyObservers(r, u, n), this;
}, enyo._getProp = function(e, t, n) {
var r = n || enyo.global;
...
}, enyo.only = function(e, t) {
var n = [], r;
if (!e || !t) return n;
!enyo.isArray(e) && e && (e = [ e ]);
for (r in t) {
if (!t.hasOwnProperty(r)) continue;
e.indexOf(r) !== -1 && n.indexOf(r) === -1 && n.push(t[r]);
}
return n;
}, enyo.pluck = function(e, t) {
var n = [], r = 0, i;
i = enyo.isArray(t) ? t : [ t ];
for (; r < i.length; ++r) {
if (!i[r]) continue;
i[r][e] && n.push(i[r][e]);
}
...
var e = enyo.toArray(arguments), t, n = 0;
t = e.length > 0 ? e.shift() : null;
if (!t || !enyo.isFunction(t) || e.length <= 0) return enyo.warn("enyo.Observer: could not return a valid observer method, must supply a function and at least one property to observer"), enyo.isFunction(t) ? t : enyo.nop;
t.isObserver = !0, t.events = t.events ? t.events : [];
for (; n < e.length; ++n) t.events.push(e[n]);
return t;
}, enyo.Computed = function() {
var e = enyo.toArray(arguments), t, n = 0;
t = e.length > 0 ? e.shift() : null;
if (!t || !enyo.isFunction(t)) return enyo.warn("enyo.Computed: could not return a valid computed property as no method was supplied"), enyo.nop;
t.isProperty = !0, t.properties = t.properties ? t.properties : [];
for (; n < e.length; ++n) t.properties.push(e[n]);
return t;
}, enyo.concat = [ "concat", "bindings" ], enyo.merge = function() {
var e = [], t = enyo.toArray(arguments), n, r = 0, i;
for (; t.length; ++r) {
n = t.shift();
if (!enyo.isArray(n)) continue;
if (r === 0) e = enyo.clone(n); else for (i = 0; i < n.length; ++i) {
if (e.indexOf(n[i]) > -1) continue;
e.push(n[i]);
}
}
return e;
}, enyo.handleConcatenatedProperties = function(e, t) {
var n = enyo.merge(e.concat, t.concat), r, i, s;
while (n.length) r = n.shift(), s = e[r], i = t[r], enyo.isArray(s) && enyo.isArray(i) && (e[r] = enyo.merge(s, i), delete t[r]);
...
return e.hasOwnProperty("constructor") && (e._constructor = e.constructor, delete e.constructor), enyo.setPrototype(o, s ? enyo.delegate(s) : {}), enyo.handleConcatenatedProperties(o.prototype, e), enyo.mixin(o.prototype, e), o.prototype.kindName = t, o.prototype.base = i, o.prototype.ctor = o, enyo.forEach(enyo.kind.features, function(t) {
t(o, e);
...
delete e.name;
var r = enyo.kind(e);
return enyo.setObject(n, new r, t);
...
(function() {
function r() {
var e = enyo.toArray(arguments), t = 0;
for (; t < e.length; ++t) enyo.mixin(this, e[t]);
enyo.bindingCount++, this.bindId = getBindingsId(), this._setup();
}
...
if (this.oneWay === !0) return;
if (!n || !enyo.isFunction(n)) n = this._targetResponder = enyo.bind(this, this._syncFromTarget);
n.bindId = this.bindId, e.addObserver(t, n);
},
_syncFromSource: function() {
this.oneWay || this._disconnectTarget(), this.setTargetValue(this.getSourceValue()), this.oneWay || this._connectTarget();
},
_syncFromTarget: function() {
this._disconnectSource(), this.setSourceValue(this.getTargetValue()), this._connectSource();
},
isConnected: !1,
isSynced: !1,
to: null,
...
allowRefresh: !0,
sync: function(e) {
if (this.isSynced && e !== !0) return;
this._syncFromSource(), this.isSynced = !0;
return;
},
refresh: function() {
if (!this.allowRefresh) return !1;
this.disconnect(), this._setup();
},
connect: function() {
if (this.isConnected) return;
this._connectSource(), this._connectTarget(), this.isConnected = !0;
},
disconnect: function() {
this._disconnectSource(), this._disconnectTarget(), this.isSynced = !1, this.isConnected = !1;
},
_disconnectSource: function() {
var e = this._sourceProperty, t = this._sourceComputedProperty;
if (!this._source) return;
this._source.removeObserver(t || e, this._sourceResponder);
},
...
this._target || enyo.error("no target", this);
var e = this._target.get(this._targetProperty);
return e instanceof Object && (e = t(e)), e;
},
setTargetValue: function(e) {
var t = this.transform && enyo.isFunction(this.transform) ? this.transform(e, "target") : e;
return this.isSynced = !0, this._target.set(this._targetProperty, t);
},
...
return this._source.set(this._sourceProperty, t);
},
destroy: function() {
this.disconnect(), this._source = null, this._target = null, this._sourceResponder = null, this._targetResponder = null, this.isDestroyed = !0, enyo.bindingCount--, this.owner && this.owner.removeBinding(this);
}
}, enyo.Binding = r;
})();
...
enyo._objectCount++, this._setup();
},
setPropertyValue: function(e, t, n) {
var r = this[e];
this[n] ? (this[e] = t, this[n](r)) : this[e] = t, r !== t && this.notifyObservers(e, r, t);
},
...
enyo.logging._log(e, [ t.callee.caller.nom + ": " ].concat(enyo.cloneArray(t)));
}
},
_setupBindings: function() {
var e, t = 0, n;
this.clearBindings(), n = this._bindings = [];
if (e = this.bindings) for (; t < e.length; ++t) n.push(new enyo.Binding({
owner: this,
autoConnect: !0
}, e[t]));
},
...
r = this._computed = {};
for (e in this) {
if (!(t = this[e])) continue;
if (enyo.isFunction(t) && t.isProperty) {
r[e] = t;
for (n = 0; n < t.properties.length; ++n) this.addObserver(t.properties[n], enyo.bind(this, function(e) {
...
for (e in this) {
if (!(t = this[e])) continue;
if (enyo.isFunction(t) && t.isObserver && t.events && t.events.length) for (n = 0; n < t.events.length; ++n) r = t.events[n], this.addObserver(r, t);
}
},
_setup: function() {
this._setupObservers(), this._setupComputed(), this._setupBindings();
},
addObserver: function(e, t, n) {
var r = this._observers, i, s;
return s = n ? enyo.bind(n, t) : t, enyo.isFunction(s) || (enyo.warn("enyo.Object.addObserver: must supply a valid function if no context is set for the callback, a default `empty` handler has been used instead (property " + e + ")"), s = enyo.nop), (i = r[e]) || (i = r[e] = []), i.indexOf(s) === -1 && i.push(s), this;
},
removeObserver: function(e, t) {
var n = this._observers, r, i;
return (r = n[e]) ? (i = r.indexOf(t), i < 0 ? this : (r.splice(i, 1), this)) : this;
},
removeAllObservers: function() {
var e = this._observers, t;
for (t in e) {
...
notifyObservers: function(e, t, n, r) {
var i = this._observers, s = this._computed, o = i[e], u = 0, a, f = e[0].toLowerCase() + e.slice(1) + "Changed";
if (o) for (; u < o.length; ++u) {
a = o[u];
if (!a || !enyo.isFunction(a)) continue;
this._allowNotifications ? a.call(this, e, t, n) : this.addNotificationToQueue(e, a, [ e, t, n ]);
}
this[f] && enyo.isFunction(this[f]) && (this._allowNotifications ? this[f].call(this, t, n) : this.addNotificationToQueue(e, this[f], [ t, n ]));
},
_notificationQueue: null,
_allowNotifications: !0,
addNotificationToQueue: function(e, t, n) {
var r = this._notificationQueue || (this._notificationQueue = {}), i = r[e];
i ? (n && i.splice(0, 1, n), i.indexOf(t) === -1 && i.push(t)) : i = r[e] = [ n || [], t ];
},
stopNotifications: function() {
this._notificationQueue = {}, this._allowNotifications = !1;
},
startNotifications: function() {
this._allowNotifications = !0, this.flushNotifications();
},
flushNotifications: function() {
var e = this._notificationQueue || {}, t, n, r, i, s;
for (n in e) {
r = e[n];
if (r && enyo.isArray(r)) {
i = r.length > 1 ? r.shift() : [];
while (r.length) t = r.shift(), t && enyo.isFunction(t) && (s = enyo.bind(this, function() {
t.apply(this, i);
}), s.call(this));
}
}
...
binding: function() {
var e = enyo.toArray(arguments), t = {}, n = 0, r;
for (; n < e.length; ++n) enyo.mixin(t, e[n]);
return r = new enyo.Binding({
owner: this,
autoConnect: !0
}, t), this._bindings.push(r), r;
},
clearBindings: function(e) {
var t = e || this._bindings, n, r;
if (t && t.length > 0) while (t.length) r = t.shift(), r.destroy();
},
refreshBindings: function(e) {
var t = e || this._bindings, n, r = 0;
for (; r < t.length; ++r) n = t[r], n.refresh();
},
removeBinding: function(e) {
var t, n = (t = this._bindings || []).indexOf(e);
n !== -1 && t.splice(n, 1);
},
get: function() {
var e = "get" + enyo.cap(arguments[0]);
return this[e] && this[e].overloaded === !0 ? this[e]() : enyo._getPath.apply(this, arguments);
},
set: function() {
return enyo._setPath.apply(this, arguments);
},
extend: function() {
var e = enyo.toArray(arguments), t, n;
while (e.length) {
t = e.shift();
for (n in t) {
if (!t.hasOwnProperty(n)) continue;
this[n] ? (this._stored || (this._stored = {}), this._stored[n] = t[n]) : this[n] = t[n];
}
}
}
...
n[s] ? n[s].overloaded !== !1 && (n[s].overloaded = !0) : (n[s] = function() {
return this.get(r);
}, n[s].overloaded = !1);
var o = "set" + i, u = r + "Changed";
n[o] || (n[o] = function() {
return this.set(r, arguments[0]);
});
};
...
destroy: function() {
this.destroyComponents(), this.setOwner(null), this.clearBindings(), this.destroyed = !0;
},
...
e && e.removeComponent(this), this.owner && this.owner.addComponent && this.owner.addComponent(this), this.id || (this.id = this.makeId());
},
...
if (this.controller && this.controller instanceof enyo.Component && this.controller.dispatchEvent(e, t, n)) return !0;
...
var r, i = this.controller;
if (i && i instanceof enyo.Component && i[e] && enyo.isFunction(i[e])) return i[e].call(i, n || this, t);
r = e && this[e];
...
create: function() {
this.controls = [], this.children = [], this.containerChanged(), this.inherited(arguments), this.layoutKindChanged(), this._setup();
},
destroy: function() {
...
start: function() {
window.onhashchange = enyo.bind(this, this.hashChanged), this.hashChanged();
},
route: function(e) {
this.location.hash = "#/" + e;
},
hashChanged: function() {
var e = this.get("routes"), t = this.get("hash");
(t === "" || !!~e.indexOf(t)) && this.get("controller").handle(t || "default");
},
...
dispatchEvent: function(e, t, n) {
return this.decorateEvent(e, t, n), this.handlers[e] && this.dispatch(this.handlers[e], t, n) ? !0 : !1;
},
destroy: function() {
this.set("isDestroyed", !0), this.inherited(arguments);
}
});
...
_base: null,
constructor: function() {
var e = this.extendFrom;
enyo.isString(e) && (e = this._base = enyo._getPath(e)), e || enyo.error("enyo.Extension: cannot find base to extend from " + this.extendFrom), this.extend(e.prototype), this._get = function() {
return enyo._getPath.apply(this, arguments);
}, this.inherited(arguments), e.apply(this, arguments);
},
get: function() {
var e;
return this._stored && this._stored.get && (e = this._stored.get.apply(this, arguments)), e === undefined ? (e = this.inherited(arguments), e) : e;
}
});
...
generated: !1,
create: function() {
this.initStyles(), this.inherited(arguments), this.showingChanged(), this.addClass(this.kindClasses), this.addClass(this.classes), this.initProps([ "id", "content", "src", "controller" ]), this._setupBindings();
},
_setup: function() {
this._setupObservers(), this._setupComputed();
},
destroy: function() {
this.controller && (this.constroller.destroy(), this.constroller = null), this.removeNodeFromDom(), enyo.Control.unregisterDomEvents(this.id), this.inherited(arguments);
},
importProps: function(e) {
...
var e = this.controller, t;
if (e && enyo.isString(e)) {
if (e[0] === "." || !(t = enyo._getPath(e))) t = enyo._getPath.call(this, e);
if (!t) throw new Error("Control.controllerChanged: could not find " + e);
} else t = e;
t && enyo.isFunction(t) && !(t instanceof enyo.Controller) && (t = new t);
if (!t) {
console.warn("Could not find requested controller instance or class ", this.kindName, e);
return;
}
t.set("owner", this), this.controller = t;
},
